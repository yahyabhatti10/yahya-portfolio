...
const projects = [
  {
    ...
    liveLink: "", 
    githubLink: "https://github.com/yahyabhatti10/ATS",
  },
  {
    title: "BISHA Events Website",
    description:
      "Crafted an elegant and responsive website for Bisha Events, a premier Lahore-based luxury event planning service, showcasing their sophisticated décor and catering offerings.",
    technologies: ["TypeScript", "React.js", "Tailwind CSS", "Vercel", "EmailJS", "Twilio"],
    liveLink: "https://bisha-events.vercel.app/",
    githubLink: "https://github.com/yahyabhatti10/bisha-events",
  },
  {
    ...
    liveLink: "https://www.feelgreathealthelixir.com/",
    githubLink: "",
  },
  {
    ...
    liveLink: "", 
    githubLink: "https://github.com/yahyabhatti10/umt-scraper",
  },
  {
    ...
    liveLink: "", 
    githubLink: "https://github.com/yahyabhatti10/Resiluxe",
  },
  {
    ...
    liveLink: "", 
    githubLink: "https://github.com/yahyabhatti10/Hospital-Emergency-Ward-System",
  },
  {
    ...
    liveLink: "", 
    githubLink: "https://github.com/yahyabhatti10/gym-website",
  },
  {
    ...
    liveLink: "", 
    githubLink: "https://github.com/yahyabhatti10",
  },
  {
    ...
    liveLink: "", 
    githubLink: "https://github.com/yahyabhatti10/AI---NameFinder-",
  },
  {
              ...
              <div className="flex gap-2">
                {project.githubLink && (
                  <a
                    ...
                    className="inline-flex items-center text-[#DDFE35] border border-[#DDFE35] px-4 py-2 rounded hover:underline"
                  >
                    View Source Code
                  </a>
                )}
